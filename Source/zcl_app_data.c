...
CONST zclAttrRec_t zclApp_Attrs1[] = {
  ...
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_RMS_VOLTAGE,        ZCL_UINT16, RR, (void *) &zcl_measured[0].voltage}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_RMS_CURRENT,        ZCL_UINT16, RR, (void *) &zcl_measured[0].current}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_ACTIVE_POWER,       ZCL_INT16,  RR, (void *) &zcl_measured[0].power}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_TOTAL_ACTIVE_POWER, ZCL_INT32,  RR, (void *) &zcl_measured[0].energy}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_AC_FREQUENCY,       ZCL_UINT16, RR, (void *) &zcl_measured[0].frequency}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_POWER_FACTOR,       ZCL_INT8,   RR, (void *) &zcl_measured[0].powerFactor}},
...
CONST zclAttrRec_t zclApp_Attrs2[] = {
  ...
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_AC_FREQUENCY_MULTIPLIER, ZCL_UINT16, R, (void *) &acFrequencyMultiplier}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_AC_FREQUENCY_DIVISOR,    ZCL_UINT16, R, (void *) &acFrequencyDivisor}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_RMS_VOLTAGE,        ZCL_UINT16, RR, (void *) &zcl_measured[1].voltage}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_RMS_CURRENT,        ZCL_UINT16, RR, (void *) &zcl_measured[1].current}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_ACTIVE_POWER,       ZCL_INT16,  RR, (void *) &zcl_measured[1].power}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_TOTAL_ACTIVE_POWER, ZCL_INT32,  RR, (void *) &zcl_measured[1].energy}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_AC_FREQUENCY,       ZCL_UINT16, RR, (void *) &zcl_measured[1].frequency}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_POWER_FACTOR,       ZCL_INT8,   RR, (void *) &zcl_measured[1].powerFactor}},
...
CONST zclAttrRec_t zclApp_Attrs3[] = {
  ...
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_AC_FREQUENCY_MULTIPLIER, ZCL_UINT16, R, (void *) &acFrequencyMultiplier}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_AC_FREQUENCY_DIVISOR,    ZCL_UINT16, R, (void *) &acFrequencyDivisor}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_RMS_VOLTAGE,        ZCL_UINT16, RR, (void *) &zcl_measured[2].voltage}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_RMS_CURRENT,        ZCL_UINT16, RR, (void *) &zcl_measured[2].current}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_ACTIVE_POWER,       ZCL_INT16,  RR, (void *) &zcl_measured[2].power}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_TOTAL_ACTIVE_POWER, ZCL_INT32,  RR, (void *) &zcl_measured[2].energy}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_AC_FREQUENCY,       ZCL_UINT16, RR, (void *) &zcl_measured[2].frequency}},
  {ZCL_CLUSTER_ID_HA_ELECTRICAL_MEASUREMENT, {ATTRID_ELECTRICAL_MEASUREMENT_POWER_FACTOR,       ZCL_INT8,   RR, (void *) &zcl_measured[2].powerFactor}},
...
void zclApp_ResetAttributesToDefaultValues(void) {
    ...
    for (i = 0; i < 3; i++) {
        zcl_measured[i].voltage = 0;
        zcl_measured[i].current = 0;
        zcl_measured[i].power = 0;
        zcl_measured[i].energy = 0;
        zcl_measured[i].frequency = 0;
        zcl_measured[i].powerFactor = 0;
    }
}
